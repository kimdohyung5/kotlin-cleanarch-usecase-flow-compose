...
import com.kimdo.cryptocurrent_compose.common.Constants
import com.kimdo.cryptocurrent_compose.common.Resource
import com.kimdo.cryptocurrent_compose.domain.use_case.GetCoinUseCase
...
@HiltViewModel
class CoinDetailViewModel @Inject constructor(private val getCoinUseCase: GetCoinUseCase, savedStateHandle: SavedStateHandle)
    : ViewModel() {
